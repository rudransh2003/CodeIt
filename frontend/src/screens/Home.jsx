    ...
    return (
        <main className="min-h-screen bg-black text-white relative">
            ...
            <section className="mt-12 px-6 text-center max-w-3xl mx-auto">
                <h2 className="text-3xl font-bold mb-4">Get Started with Your Workspace</h2>
                <p className="text-gray-400 text-lg mb-10">
                    Organize your ideas, work with your team, and boost productivity using AI-powered prompts.
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-black/70 border border-white/10 p-6 rounded-xl shadow-md hover:bg-white/5 transition">
                        ...
                        <p className="text-gray-400 text-sm">
                            Start by creating a new project to organize your work in one place.
                        </p>
                    </div>
                    <div className="bg-black/70 border border-white/10 p-6 rounded-xl shadow-md hover:bg-white/5 transition">
                        ...
                        <p className="text-gray-400 text-sm">
                            Invite your team members and collaborate in real time on shared projects.
                        </p>
                    </div>
                    <div className="bg-black/70 border border-white/10 p-6 rounded-xl shadow-md hover:bg-white/5 transition">
                        <i className="ri-robot-line text-3xl mb-3 text-white"></i>
                        <h3 className="text-xl font-semibold mb-2">Write AI Prompts</h3>
                        <p className="text-gray-400 text-sm">
                            Use AI to brainstorm ideas, generate content, and automate repetitive tasks.
                        </p>
                    </div>
                </div>
            </section>
            ...
            {/* Project List */}
            {projectModal && (
                <section className="mt-10 px-6 flex flex-wrap gap-6 justify-center">
                    {project.length === 0 ? (
                        ...
                        project.map((p) => (
                            <div
                                key={p._id}
                                className="relative bg-black/70 border border-white/10 rounded-xl p-6 w-64 shadow-lg cursor-pointer hover:bg-white/10 transition"
                            ...
                            >
                                ...
                                {hoveredProject === p._id && (
                                    <div className="absolute -top-16 left-1/2 -translate-x-1/2 bg-black border border-white/20 rounded-md p-3 shadow-lg w-56 text-sm z-10">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm z-50">
                    <div className="bg-black/90 border border-white/10 rounded-xl p-8 w-full max-w-lg shadow-2xl">
